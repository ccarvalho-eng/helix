	...
	return (
		<div
			...
			style={{
				...
				padding: "16px",
				cursor:
					mode === "connect" ? "crosshair" : isDragging ? "grabbing" : "grab",
				display: "flex",
		...
		>
			...
			<div style={{ textAlign: "center", lineHeight: "1.2" }}>{node.label}</div>
		</div>
	);
}
	...
	return (
		...
		>
			...
			<div>
				...
				<div
					...
					onClick={() => {
						...
						onAddNode(
							...
							200,
							"Mission Brief",
							"Receive assassination target and intel",
						);
						onAddNode(
							"sensor",
							250,
						...
						onAddNode(
							...
							50,
							"Ezio Auditore",
							"Master strategist, plans the approach and coordinates team",
						);
						onAddNode(
							"agent",
							450,
							170,
							"Altaïr Ibn-LaAhad",
							"Legendary assassin, executes high-priority eliminations",
						);
						onAddNode(
							"agent",
							450,
							290,
							"Bayek of Siwa",
							"Hidden One, investigates targets and gathers intelligence",
						);
						onAddNode(
							"agent",
							450,
							410,
							"Edward Kenway",
							"Pirate assassin, handles naval operations and combat",
						);
						onAddNode(
							"skill",
							700,
						...
						onAddNode(
							...
							330,
							"Combat Training",
							"Sword fighting and counter-attacks",
						);
						onAddNode(
							"decision",
							900,
							230,
							"Mission Success?",
							"Evaluate if target eliminated and escape completed",
						);
						onAddNode(
							"output",
							1100,
							230,
							"Brotherhood Report",
							"Mission status and next objectives",
						);
					}}
					onMouseOver={(e) => {
						e.currentTarget.style.background = "#f9fafb";
				...
				>
					<div
						style={{ fontSize: "13px", fontWeight: "400", color: "#1f2937" }}
					>
...
export function WorkingAIFlowBuilder() {
	...
	const [connections, setConnections] = useState<AIFlowConnection[]>(
