				...
				<div className="properties-panel__help">
					...
					<div className="properties-panel__help-list">
						<div className="properties-panel__help-item">
							<span className="properties-panel__help-label">Agent:</span> Core
							AI reasoning unit
						</div>
						<div className="properties-panel__help-item">
							<span className="properties-panel__help-label">Sensor:</span>{" "}
							Real-time data collection
						</div>
						<div className="properties-panel__help-item">
							<span className="properties-panel__help-label">Skill:</span>{" "}
							Specialized capabilities
						</div>
						<div className="properties-panel__help-item">
							<span className="properties-panel__help-label">Decision:</span>{" "}
							Conditional logic routing
						</div>
						<div className="properties-panel__help-item">
							<span className="properties-panel__help-label">
								Input/Output:
							</span>{" "}
				...
				<div className="properties-panel__help">
					...
					<div className="properties-panel__help-list">
						<div className="properties-panel__help-item">
							...
							Click or drag from palette
						</div>
						<div className="properties-panel__help-item">
							<span className="properties-panel__help-label">Connect:</span>{" "}
							Drag from node handle to another
						</div>
						<div className="properties-panel__help-item">
						...
						<div className="properties-panel__help-item">
							<span className="properties-panel__help-label">Resize:</span> Drag
						...
						<div className="properties-panel__help-item">
							...
							Drag on empty space to select multiple
						</div>
						<div className="properties-panel__help-item">
							<span className="properties-panel__help-label">Minimap:</span> Use
							overview map (bottom-right) to navigate
						</div>
					</div>
				</div>
		...
		<div className="properties-panel__fields">
			...
			<div className="properties-panel__field">
				...
				<input
					...
					onChange={(e) =>
						handleConnectionUpdate({ width: parseInt(e.target.value) })
					}
					className="properties-panel__range"
				/>
				<span className="properties-panel__range-value">
