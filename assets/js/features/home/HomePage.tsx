      ...
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Design AI agent workflows with visual diagrams. Create, connect, and orchestrate intelligent systems.
          </p>
        </div>
        ...
        <div className="border-t border-gray-200 pt-12">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Recent Workflows</h2>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="group relative bg-gray-50 rounded-lg p-6 hover:bg-gray-100 transition-colors cursor-pointer">
              ...
              <h3 className="font-medium text-gray-900 mb-2">Assassin's Creed Brotherhood</h3>
              <p className="text-sm text-gray-600 mb-3">Multi-agent workflow with Ezio, Altaïr, and team coordination</p>
